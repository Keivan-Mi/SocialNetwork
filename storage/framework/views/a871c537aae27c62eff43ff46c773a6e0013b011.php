    ...
    <div class="row">
        ...
        <div class="col-9 pt-5 ">
            ...
            <div class="d-flex">
                ...
                <div class="pr-3"><strong><?php echo e($user->profile->followers->count()); ?></strong> followers</div>
                <div class="pr-3"><strong><?php echo e($user->following->count()); ?></strong> following</div>
            </div>
