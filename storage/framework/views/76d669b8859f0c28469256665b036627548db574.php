    ...
    <div class="row">
        ...
        <div class="d-flex">
            ...
            <div class="row d-inline-block">
                <follow-button user-id="<?php echo e($user->id); ?>" follow="<?php echo e($follows); ?>" username="<?php echo e($user->username); ?>" posts="<?php echo e($user->posts->count()); ?>" followers="<?php echo e($user->profile->followers->count()); ?>" following="<?php echo e($user->following->count()); ?>" ownprofile="<?php echo e($ownProfile); ?>">
                </follow-button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\University\Term 7\Internet Engineering\Project\Final\SocialNetwork\resources\views/profiles/index.blade.php ENDPATH**/ ?>